...
void display(){	
	...
	glBegin(GL_POLYGON);
		glVertex2f(0.5, -0.5);
		glVertex2f(0.5, -1.0);
		glVertex2f(0.166, -1.0);
		glVertex2f(0.166, -0.5);
	glEnd();
	//midd portion of windmill 
	glColor3f(1.0,1.0,1.0);
	glBegin(GL_POLYGON);
		glVertex2f(0.166, -0.5);
		glVertex2f(0.166, -1.0);
	...
	//WINDMILL FF
	glBegin(GL_POLYGON);
		glVertex2f(Fan*cos(dtr*(theta + 
5)),1.0+Fan*sin(dtr*(theta + 5)));
		glVertex2f(Fan*cos(dtr*(theta + 
175)),1.0+Fan*sin(dtr*(theta + 175)));
		glVertex2f(Fan*cos(dtr*(theta + 
185)),1.0+Fan*sin(dtr*(theta + 185)));
		glVertex2f(Fan*cos(dtr*(theta + 
355)),1.0+Fan*sin(dtr*(theta + 355)));
	glEnd();
	//WINDMILL SF
	glBegin(GL_POLYGON);
		glVertex2f(Fan*cos(dtr*(theta + 
85)),1.0+Fan*sin(dtr*(theta + 85)));
		glVertex2f(Fan*cos(dtr*(theta + 
95)),1.0+Fan*sin(dtr*(theta + 95)));
		glVertex2f(Fan*cos(dtr*(theta + 
265)),1.0+Fan*sin(dtr*(theta + 265)));
		glVertex2f(Fan*cos(dtr*(theta + 
275)),1.0+Fan*sin(dtr*(theta + 275)));
	glEnd();
	...
	glBegin(GL_POLYGON);
		glVertex2f(scaleCent*cos(dtr*(theta + 45)), 1.0+scaleCent*sin(dtr*(theta + 45)));
		glVertex2f(scaleCent*cos(dtr*(theta + 135)), 1.0+scaleCent*sin(dtr*(theta + 135)));
		glVertex2f(scaleCent*cos(dtr*(theta + 225)), 1.0+scaleCent*sin(dtr*(theta + 225)));
		glVertex2f(scaleCent*cos(dtr*(theta + 315)), 1.0+scaleCent*sin(dtr*(theta + 315)));
	glEnd();
