...
public class GUI implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) 
    {
        if (event.getActionCommand().equals("Bouncing Ball")) {
        	...
        	catch(UmbrellaStateException soloHan){
        		JOptionPane.showMessageDialog(frame, "ERROR, ERROR, ERROR"+darthPlagueis.getMessage());
        	}
        	...
        	//PART 1 AND PART 2 START HERE //
        	throw new BouncingBananaException(); 
        	// PART 1 AND 2 END HERE // 
        } else {
